     ...
     <div class="auto-container">
         <div class="sec-title text-center">
             ...
             <?php if (isset($_GET['id'])) {
                    $sql  = "select cat_name , cat_id  from category where cat_id= {$_GET['id']}";
                    $cat = mysqli_fetch_assoc(mysqli_query($conn, $sql));
                    if ($_GET['id'] == $cat['cat_id']) {
                        echo ' <h2> Store ' . $cat['cat_name'] . ' </h2>';
                    }
                } else {
                    echo ' <h2> Stores </h2>';
                }
         ...
         <div class="row">
             ...
             <?php
                if (isset($_GET['id'])) {
                    ...
                    $catId = $cat['cat_id'];
                    if ($_GET['id'] == $catId) {
                        $query  = "select * from store  where cat_id= $catId";
                        $result3 = mysqli_query($conn, $query);
                        while ($row = mysqli_fetch_assoc($result3)) {
                            echo '<a href="store.php?id=' . $row['store_id'] . '&type=' . $row['store_name'] . '"><div class="portfolio-block col-lg-3 col-md-6 col-sm-12"><div class="inner-box">
                             <div class="image-box"> <figure class="image">';
                            echo ' <img src="images/catogary/' . $row['store_img'] . '" alt="" style="height: 17rem">';
                            echo ' </figure> </div><div class="portfolio-hover"><div class="hover-effect"><svg x="0px" y="0px" viewBox="79 -202.7 1000 1000">
                            ...
                            echo '<h3><a href="store.php?id=' . $row['store_id'] . '&type=' . $row['store_name'] . '">' . $row['store_name'] . '</a></h3> </div></div> </div></a>';
                        }
                    }
                } else {
