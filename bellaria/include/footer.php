...
<footer class="main-footer">
    <div class="shape_wrapper shape_one">
        <div class="shape_inner" style="background-image: url(images/bk1.jpg);">
            ...
            <div class="row">
                ...
                <div class="footer-column col-lg-4 col-md-12 col-sm-12">
                    ...
                    <div class="footer-widget logo-widget">
                        <figure class="footer-logo"><img src="images/sd.png" alt=""></figure>
                    </div>
                </div>
    ...
    <div class="footer-bottom">
        <div class="auto-container">
            <div class="copyright-text">
                <p>Te7lay - Jenan Musallam | Abdallah alhajeid | Diaa jamel | Lubna amjad | Mohammad bdour | Suhaib alabed</p>
            </div>
        </div>
    </div>
</footer>
